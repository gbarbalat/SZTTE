...
w_ipw <- ipwpoint(
  ...
  denominator = ~ Sex + AGE_AT_ALD + Calendar_year+ URBANcat_2009,#models the full treatment mechanism conditional on confounders
...
save(POGEE_allcauses,POGEE_surv, POGEE_nat, POGEE_unnat, 
     file=paste0("./sasdata1/download/",analysis, "_IAEDI_POGEE.RData"))
...
if (analysis=="bsl") {
  ...
  save(POGEE_allcauses,POGEE_surv, POGEE_nat, POGEE_unnat, 
       file=paste0("./sasdata1/download/",analysis, "_IAEDI_ipw_POGEE.RData"))
}